...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBillboardWidgetComponent_Statics::NewProp_LockZAxis = { UE4CodeGen_Private::EPropertyClass::Bool, "LockZAxis", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000015, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UBillboardWidgetComponent), &Z_Construct_UClass_UBillboardWidgetComponent_Statics::NewProp_LockZAxis_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBillboardWidgetComponent_Statics::NewProp_LockZAxis_MetaData, ARRAY_COUNT(Z_Construct_UClass_UBillboardWidgetComponent_Statics::NewProp_LockZAxis_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBillboardWidgetComponent_Statics::ClassParams = {
		...
		0x00A010A0u,
		nullptr, 0,
		Z_Construct_UClass_UBillboardWidgetComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UBillboardWidgetComponent_Statics::PropPointers),
		nullptr,
	...
	IMPLEMENT_CLASS(UBillboardWidgetComponent, 4076727763);
